...
public class OrderQueryRepository {
    ...
    public List<OrderQueryDto> findOrders() {
        ...
        return em.createQuery("select new com.example.w01.repository.order.query.OrderQueryDto(o.id, m.name, o.orderDate, o.status, d.address)" +
                        " from Order o " +
                        "join o.member m " +
    ...
    private List<OrderItemQueryDto> findOrderItems(Long orderId) {
        return em.createQuery("select new com.example.w01.repository.order.query.OrderItemQueryDto(oi.order.id, i.itemName, oi.orderPrice, oi.orderCount)" +
                "from OrderItem oi " +
                "join oi.item i " +
